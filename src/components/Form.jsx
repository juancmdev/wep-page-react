...
const Form = () => {
  ...
  return (
    <div className="my-3">
      <form onSubmit={handleSubmit} className="w-4/6 mx-auto">
        <input
          type="text"
        ...
        <textarea
          ...
          onChange={(e) => setTodo({ ...todo, todoMensaje: e.target.value })}
        />
        <button className="submit btn btn-warning mt-3 hover:bg-black hover:text-yellow-400">
          Enviar
        </button>
      </form>
    </div>
